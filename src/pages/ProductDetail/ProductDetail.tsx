...
export default function ProductDetail() {
  ...
  const handleZoom = (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    // cách 1 xử lý bubble event lấy offset đơn giản
    const { offsetX, offsetY } = e.nativeEvent

    // cách 2 lấy offset khi không xử lý đc bubble event sử dụng khi không xử lý được css
  ...
  return (
    <div className='bg-[#f5f5f5] py-6'>
            ...
            <div className='col-span-5'>
              ...
              <div className='relative mt-4 grid grid-cols-5 gap-3'>
                ...
                {currentImgs.map((img) => {
                  ...
                  return (
                    <div className='relative w-full pt-[100%] shadow' key={img} onMouseEnter={() => handleHover(img)}>
                      <img
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                ...
                <div>
                  ...
                  <span className='ml-2 capitalize text-gray-500'>Đã bán</span>
                </div>
              </div>
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                ...
                <div
                  className='ml-4 rounded-sm bg-orange px-1 py-[2px] font-semibold uppercase text-white
                '
                >
              ...
              <div className='mt-8 flex items-center'>
                ...
                >
                  <svg
                    ...
                    x={0}
                    y={0}
                    className='mr-2 h-5 w-5 fill-current stroke-orange'
                  >
                    <g>
                      <g>
                        <polyline
      ...
      <div className='mt-8'>
        <div className='container'>
          <div className='text-lg uppercase text-gray-500'>có thể bạn cũng thích</div>
